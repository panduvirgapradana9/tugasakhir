      ...
      <div class="card">
        ...
        <div class="card-body">
          ...
          <form action="{{ route('produk.update', $itemproduk->id) }}" method="post">
            ...
            <div class="form-group">
              <label for="supplier_id">Supplier Produk</label>
              <select name="supplier_id" id="supplier_id" class="form-control">
                <option value="">Pilih Supplier</option>
                @foreach($itemsupplier as $supplier)
                <option value="{{ $supplier->id }}" {{ $itemproduk->supplier_id == $supplier->id ? 'selected' : ''}}>{{ $supplier->nama }}</option>
                @endforeach
              </select>
            </div>
            {{-- <div class="form-group">
            ...
            <div class="form-group">
              ...
              <input type="date" name="exp_date" id="exp_date" value={{ $itemproduk->exp_date }} class="form-control">
            </div>
            <div class="form-group">
