            ...
            <table class="table table-bordered">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <p>Deskripsi<br>
                    {{ $produk->deskripsi_produk}}<br>
                    
                    @if ( Carbon\Carbon::parse($produk->exp_date)->diffInDays() <= 21 )
                      <p style="color: red">
                        Tanggal Kadaluarsa {{ Carbon\Carbon::parse($produk->exp_date)->format('d M Y') }} ({{Carbon\Carbon::parse($produk->exp_date)->diffInDays()}} hari lagi)
                      </p>
                    @else
                      Tanggal Kadaluarsa {{ Carbon\Carbon::parse($produk->exp_date)->format('d M Y') }}
                    @endif
