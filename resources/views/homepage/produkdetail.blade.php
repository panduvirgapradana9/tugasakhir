      ...
      <div id="carousel" class="carousel slide" data-ride="carousel">
        ...
        @if($index == 0)
          <div class="carousel-item active">
              <img src="{{ asset('storage/'.$image->foto) }}" class="d-block w-100" alt="...">
          </div>
        @else
        ...
        <div class="col">
          <div class="card">
            <div class="card-body">
              ...
              <p>
                Rp. <del class="small">{{ number_format($itemproduk->promo->harga_awal, 2) }}</del>
                <br />
              </p>
              <p style="color:red">
    ...
    <div class="col">
      <div class="card">
        ...
        <div class="card-body">
          ...
          <br><br>
          Tanggal Kadaluarsa {{ Carbon\Carbon::parse($itemproduk->exp_date)->format('d m Y') }}
        </div>
      </div>
    </div>
  </div>
